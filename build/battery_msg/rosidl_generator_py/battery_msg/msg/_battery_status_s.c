...
bool battery_msg__msg__battery_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("battery_msg.msg._battery_status.BatteryStatus", full_classname_dest, 45) == 0);
  }
  battery_msg__msg__BatteryStatus * ros_message = _ros_message;
  {  // voltage
...
PyObject * battery_msg__msg__battery_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("battery_msg.msg._battery_status");
