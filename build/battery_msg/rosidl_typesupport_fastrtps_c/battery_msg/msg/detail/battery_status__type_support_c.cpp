...
#include "battery_msg/msg/detail/battery_status__rosidl_typesupport_fastrtps_c.h"
...
using _BatteryStatus__ros_msg_type = battery_msg__msg__BatteryStatus;
...
static uint32_t _BatteryStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_battery_msg__msg__BatteryStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = battery_msg__msg__BatteryStatus;
    is_plain =
      (
...
static size_t _BatteryStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_battery_msg__msg__BatteryStatus(
